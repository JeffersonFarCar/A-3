...
public class Shinee extends AppCompatActivity {

    Toolbar toolbar;
    TabLayout tabLayout;
    ViewPager viewPager;
    PageAdaptershinee pageAdapterbts;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_shinee);
        ...
        pageAdapterbts = new PageAdaptershinee(getSupportFragmentManager(), tabLayout.getTabCount());
        viewPager.setAdapter(pageAdapterbts);
